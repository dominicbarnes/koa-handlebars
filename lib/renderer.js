...
Renderer.prototype.viewPath = function (id) {
  var o = this.options;
  return path.resolve(o.root, o.viewPath, id + o.extension);
};
...
Renderer.prototype.layoutPath = function (id) {
  var o = this.options;
  return path.resolve(o.root, o.layoutPath, id + o.extension);
};
...
Renderer.prototype.partialPath = function (id) {
  var o = this.options;
  if (id) return path.resolve(o.root, o.partialPath, id + o.extension);
  return path.resolve(o.root, o.partialPath);
};
...
Renderer.prototype.getPartials = function *() {
  debug("searching for partials in %s", this.options.partialPath.grey);
...
Renderer.prototype.watchPartials = function () {
  ...
  debug("monitoring %s for partials", this.options.partialPath.grey);
