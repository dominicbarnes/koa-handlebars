...
Renderer.prototype.helper = function (name, fn) {
  ...
  if (typeof fn === 'function') {
      this.handlebars.registerHelper(name, function() {
        this.handlebars = self.handlebars;
  ...
  if (typeof name === 'object') {
      wrappedHelpers = Object.keys(name).reduce(function(helpers, helper){
          helpers[helper] = function() {
              this.handlebars = self.handlebars;
              return name[helper].apply(this, arguments);
          }
          return helpers;
      }, {});

      this.handlebars.registerHelper(wrappedHelpers);
  }
};
